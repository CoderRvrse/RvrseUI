-- RvrseUI v4.3.25 | Modern Professional UI Framework
-- Compiled from modular architecture on 2025-12-01T22:00:00Z
...
do
	...
	Version.Data = {
		...
		Minor = 3,
		Patch = 25,
		Build = "20251201b",  -- YYYYMMDD format
		Full = "4.3.25",
		Hash = "A8E5C9B2",  -- Release hash for integrity verification
