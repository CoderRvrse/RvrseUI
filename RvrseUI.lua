-- RvrseUI v4.3.26 | Modern Professional UI Framework
-- Compiled from modular architecture on 2025-12-01T23:30:00Z
...
do
	...
	Version.Data = {
		...
		Minor = 3,
		Patch = 26,
		Build = "20251201c",  -- YYYYMMDD format
		Full = "4.3.26",
		Hash = "F4D1B7E9",  -- Release hash for integrity verification
