-- RvrseUI v4.3.3 | Modern Professional UI Framework
-- Compiled from modular architecture on 2025-10-21T22:15:47.582Z
...
do
	...
	Version.Data = {
		...
		Minor = 3,
		Patch = 3,
		Build = "20251021c",  -- YYYYMMDD format
		Full = "4.3.3",
		Hash = "J7P5Z2K4",  -- Release hash for integrity verification
