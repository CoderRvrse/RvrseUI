-- RvrseUI v4.3.4 | Modern Professional UI Framework
-- Compiled from modular architecture on 2025-10-21T23:05:12.184Z
...
do
	...
	Version.Data = {
		...
		Minor = 3,
		Patch = 4,
		Build = "20251021d",  -- YYYYMMDD format
		Full = "4.3.4",
		Hash = "Q8L6Y1F2",  -- Release hash for integrity verification
